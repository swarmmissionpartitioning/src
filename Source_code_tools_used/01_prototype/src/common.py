...
class Reports:
    def __init__(self):
        self.sp_leader = [0.0, 0.0]
        self.sp_f1 = [0.0, 0.0]
        self.sp_f2 = [0.0, 0.0]
        self.sp_f3 = [0.0, 0.0]

        self.ep_leader = [0.0, 0.0]
        self.ep_f1 = [0.0, 0.0]
        self.ep_f2 = [0.0, 0.0]
        self.ep_f3 = [0.0, 0.0]
...
class Params:
    def __init__(self):
        ...
        self.world_bounds_x = [-MAP_BOUNDS_METER_new_x, MAP_BOUNDS_METER_new_x]# [-2.5, 2.5]

        # [m], map size in Y-direction
        self.world_bounds_y = [-MAP_BOUNDS_METER_new_y, MAP_BOUNDS_METER_new_y]# [-2.5, 2.5]
