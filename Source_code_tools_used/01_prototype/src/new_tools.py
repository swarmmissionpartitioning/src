...
class Robot:
    ...
    def new_local_planner(self, obs, params):
        ...
        self.U, self.U_a, self.U_r, self.d2, self.U_r_d0 = combined_potential(obstacles_grid, self.sp_global, d0_m_coef, params.influence_radius, params.attractive_coef, params.repulsive_coef)
...
def move_special_obs_in_sim(obs_element):
    ...
    # obs_element = [[0, temp_bit], [0.01, temp_bit], [0.01, temp_bit+0.01], [0, temp_bit+0.01]]
    obs_element = [[-1.4, -5.0], [-1.2, -5.0], [-1.2, -4.5], [-1.4, -4.5]]
