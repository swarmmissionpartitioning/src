...
COMPLEX_OBS_T_1 = [
    ...
    # room
    # bottom
    np.array([[-5.0, -2.5], [5.0, -2.5], [5.0, -2.47], [-5.0, -2.47]]),
    # top
    np.array([[-5.0, 2.47], [5.0, 2.47], [5.0, 2.5], [-5.0, 2.5]]),
    # left
    np.array([[-5.0, -2.47], [-4.97, -2.47], [-4.97, 2.47], [-5.0, 2.47]]),
    # right
    np.array([[4.97, -2.47], [5.0, -2.47], [5.0, 2.47], [4.97, 2.47]]),
