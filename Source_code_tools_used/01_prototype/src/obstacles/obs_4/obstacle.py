...
wall_2_l_b_x = 7.5#0.0
wall_2_l_b_y = -0.5#-2.5
wall_2_r_t_x = 8.0#0.5
wall_2_r_t_y = 2.0#1.0

wall_3_l_b_x = 0.0#8.0
wall_3_l_b_y = -2.0#-0.5
wall_3_r_t_x = 0.5#8.5
wall_3_r_t_y = 0.5#2.5
