...
COMPLEX_OBS_T_1 = [
    ...
    # # room # landscape
    # # bottom
    # np.array([[-10.0, -2.0], [10.0, -2.0], [10.0, -1.97], [-10.0, -1.97]]),
    # # top
    # np.array([[-10.0, 1.97], [10.0, 1.97], [10.0, 2.0], [-10.0, 2.0]]),
    # # left
    # np.array([[-10.0, -1.97], [-9.97, -1.97], [-9.97, 1.97], [-10.0, 1.97]]),
    # # right
    # np.array([[9.97, -1.97], [10.0, -1.97], [10.0, 1.97], [9.97, 1.97]]),

    # room # portrate
    # bottom
    np.array([[-2.0, -10.0], [2.0, -10.0], [2.0, -9.97], [2.0, -9.97]]),
    # top
    np.array([[-2.0, 9.97], [2.0, 9.97], [2.0, 10.0], [-2.0, 10.0]]),
    # left
    np.array([[-2.0, -9.97], [-1.97, -9.97], [-1.97, 9.97], [-2.0, 9.97]]),
    # right
    np.array([[1.97, -9.97], [2.0, -9.97], [2.0, 9.97], [1.97, 9.97]]),
