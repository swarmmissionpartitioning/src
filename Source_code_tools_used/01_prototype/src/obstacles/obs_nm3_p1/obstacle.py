...
wall_4_l_b_x = 12.5#-5.0 
wall_4_l_b_y = 12.5#4.8
wall_4_r_t_x = 12.5#-3.0
wall_4_r_t_y = 12.5#5.0
# right wall of the door
wall_5_l_b_x = 12.5#-1.0#-2.0
wall_5_l_b_y = 12.5#4.8
wall_5_r_t_x = 12.5#5.0
wall_5_r_t_y = 12.5#5.0#0.2
