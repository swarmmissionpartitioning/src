...
XY_START = np.array([4.0, 4.5 - 0.2]) #for p1
XY_GOAL = np.array([-2.0, -2.0 - 0.5]) #for p1

INHERITED = False #when it is true, coordinates are set manually in planner.py
DES2 = np.array([ 2.05, -4.4330127])
DES3 = np.array([ 2.05, -4.4330127])
DES4 = np.array([ 2.05, -4.4330127])

APPLIED_MODIFIED_P = False
MODIFIED_P = np.genfromtxt("input/modified_p/nm3_p1/modified_p.csv", delimiter = ',')
