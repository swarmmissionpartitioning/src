...
# bottom
wall_1_l_b_x = -3.0
wall_1_l_b_y = 4.0 - 0.5
wall_1_r_t_x = 2.0
wall_1_r_t_y = 4.2 - 0.5
# right wall
wall_2_l_b_x = 4.0
wall_2_l_b_y = 4.0 - 0.5
wall_2_r_t_x = 5.0
wall_2_r_t_y = 4.2 - 0.5
# left wall
wall_3_l_b_x = -3.0
wall_3_l_b_y = 2.3 - 0.5
wall_3_r_t_x = 5.0
wall_3_r_t_y = 2.5 - 0.5
# left wall of the door
wall_4_l_b_x = -3.0
wall_4_l_b_y = -2.0 - 0.5
wall_4_r_t_x = -2.8
wall_4_r_t_y = 2.3 - 0.5
# right wall of the door
wall_5_l_b_x = -3.0
wall_5_l_b_y = -5.0
wall_5_r_t_x = -2.8
wall_5_r_t_y = -4.0 - 0.5

wall_6_l_b_x = -3.0#4.0#2.0
wall_6_l_b_y = 4.0 - 0.5#-2.5#-3.0
wall_6_r_t_x = -2.8#4.2#2.2
wall_6_r_t_y = 5.0#2.0#1.0
