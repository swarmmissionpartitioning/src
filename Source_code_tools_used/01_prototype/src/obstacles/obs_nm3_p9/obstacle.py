...
# right wall
wall_2_l_b_x = -1.0
wall_2_l_b_y = 3.0 - 3.0
wall_2_r_t_x = 3.2
wall_2_r_t_y = 3.2 - 3.0
# left wall
wall_3_l_b_x = -5.0
wall_3_l_b_y = 3.0 - 3.0
wall_3_r_t_x = -3.0
wall_3_r_t_y = 3.2 - 3.0
# left wall of the door
wall_4_l_b_x = 12.5#-1.0
wall_4_l_b_y = 12.5#3.0
wall_4_r_t_x = 12.5#3.2
wall_4_r_t_y = 12.5#3.2
# right wall of the door
wall_5_l_b_x = 12.5#-5.0
wall_5_l_b_y = 12.5#3.0
wall_5_r_t_x = 12.5#-3.0
wall_5_r_t_y = 12.5#3.2
