...
def grid_map(obstacles, nrows=MAP_SIZE_new_y, ncols=MAP_SIZE_new_x):
    ...
    for obstacle in obstacles:
        # HERE IS THE PROBLEM!!
        x1 = meters2grid_y(obstacle[0][1]); x2 = meters2grid_y(obstacle[2][1])
        
        y1 = meters2grid_x(obstacle[0][0]); y2 = meters2grid_x(obstacle[2][0])
        if x1 > x2: tmp = x2; x2 = x1; x1 = tmp
        if y1 > y2: tmp = y2; y2 = y1; y1 = tmp
        # print("x1: %f, %d, x2: %f, %d, y1: %f, %d, y1: %f, %d," % \
        #     (obstacle[0][1], x1, obstacle[2][1], x2, obstacle[0][0], y1, obstacle[2][0], y2))
        # print("###################################################")
        # print("obstacle[0][1]: "+str(obstacle[0][1]) + " x1:"+str(x1))
        # print("obstacle[2][1]: "+str(obstacle[2][1]) + " x2:"+str(x2))
        # print("obstacle[0][0]: "+str(obstacle[0][0]) + " y1:"+str(y1))
        # print("obstacle[2][0]: "+str(obstacle[2][0]) + " y2:"+str(y2))
        grid[x1:x2, y1:y2] = 1
    return grid
